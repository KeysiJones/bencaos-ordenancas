 ...
 */
class OracaoPaoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val inflater = inflater.inflate(R.layout.fragment_oracao_pao, container, false)
        val toolbar = inflater.findViewById<Toolbar>(R.id.oracao_pao_toolbar)
